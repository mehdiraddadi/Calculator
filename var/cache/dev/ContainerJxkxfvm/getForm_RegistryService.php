...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\CalculatorType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\CalculatorType']) ? $this->services['AppBundle\\Form\\CalculatorType'] : ($this->services['AppBundle\\Form\\CalculatorType'] = new \AppBundle\Form\CalculatorType())) && false ?: '_'};
